# Модифицировать метод Rectangle, добавив перезагрузку оператора "==" и сравнить экземпляры одного класса:
# Добавить к класс Circle с параметром радиус и метод для расчёта площади:
# Прямоугольник
# class Rectangle:
